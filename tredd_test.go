...
func TestServeGetDecrypt(t *testing.T) {
	const (
		clearRootHex      = "394c30333e8ec004b2de9fc3b08cd6503c2e21a039b68520127a85a93166469f"
		wantCipherRootHex = "3b73ab5cce30c2cfa73ac29d2ae9de94154c7fd98070e676d8be215d4ecb74d2"
	)
